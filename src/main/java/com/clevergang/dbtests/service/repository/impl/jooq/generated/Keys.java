...
import com.clevergang.dbtests.service.repository.impl.jooq.generated.tables.records.ProjectRecord;
...
public class Keys {
	...
	private static class ForeignKeys0 extends AbstractKeys {
		public static final ForeignKey<DepartmentRecord, CompanyRecord> DEPARTMENT__DEPARTMENT_COMPANY_PID_FKEY = createForeignKey(com.clevergang.dbtests.service.repository.impl.jooq.generated.Keys.COMPANY_PKEY, Department.DEPARTMENT, Department.DEPARTMENT.COMPANY_PID);
		public static final ForeignKey<EmployeeRecord, DepartmentRecord> EMPLOYEE__EMPLOYEE_DEPARTMENT_PID_FKEY = createForeignKey(com.clevergang.dbtests.service.repository.impl.jooq.generated.Keys.DEPARTMENT_PKEY, Employee.EMPLOYEE, Employee.EMPLOYEE.DEPARTMENT_PID);
		public static final ForeignKey<ProjectemployeeRecord, ProjectRecord> PROJECTEMPLOYEE__PROJECTEMPLOYEE_PROJECT_PID_FKEY = createForeignKey(com.clevergang.dbtests.service.repository.impl.jooq.generated.Keys.PROJECT_PKEY, Projectemployee.PROJECTEMPLOYEE, Projectemployee.PROJECTEMPLOYEE.PROJECT_PID);
		public static final ForeignKey<ProjectemployeeRecord, EmployeeRecord> PROJECTEMPLOYEE__PROJECTEMPLOYEE_EMPLOYEE_PID_FKEY = createForeignKey(com.clevergang.dbtests.service.repository.impl.jooq.generated.Keys.EMPLOYEE_PKEY, Projectemployee.PROJECTEMPLOYEE, Projectemployee.PROJECTEMPLOYEE.EMPLOYEE_PID);
	}
}
