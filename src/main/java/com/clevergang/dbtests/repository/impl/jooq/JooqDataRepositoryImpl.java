...
//        RegisterEmployee output = Routines.registerEmployee(create.configuration(), name, surname, email, salary, departmentName, companyName);
        Result<RegisterEmployeeRecord> output = Routines.registerEmployee(create.configuration(), name, surname, email, salary, departmentName, companyName);

        result.setCompanyPid(output.get(0).getCompanyId());
        result.setDepartmentPid(output.get(0).getDepartmentId());
        result.setEmployeePid(output.get(0).getEmployeeId());
